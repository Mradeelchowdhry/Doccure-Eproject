...
?>
											...
											<div class="form-group form-focus">
												<input type="text" name="speciality" class="form-control floating">
...
$validExtensions=['jpg','png','jpeg'];
 ...
 else
 {
	...
	$userid=$row['id'];
	$insert="INSERT INTO `doctors`(`user_id`, `name`, `specialization`, `availability`, `city_id`, `doc_image`) VALUES ('$userid','$username','$speciality','$availibilty','$city','$imgname');";
