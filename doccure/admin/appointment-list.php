									...
									<div class="table-responsive">
										<table class="datatable table table-hover table-center mb-0">
											...
											<tbody>
												...
												$read = "SELECT  *, doc.name as `doc_name`,p.name as `pat_name` FROM `appointments` as d INNER JOIN `doctors` as doc on d.doctor_id=doc.doctor_id INNER JOIN `patients` as p on d.patient_id=p.patients_id ;";
												...
												if ($result) {
													if (mysqli_num_rows($result) > 0) {
                                                        ...
                                                        <td> <a name='accept'  href='updateapptstatus.php?a_id=".$id."&action=accept' class='btn btn-success'>Accept</a></td>
														<td> <a name='reject' href='updateapptstatus.php?a_id=".$id."&action=reject' class='btn btn-danger'>Reject</a>
														</td>
