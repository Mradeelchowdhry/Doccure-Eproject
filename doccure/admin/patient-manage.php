...
<head>
        ...
        <title>Doccure - Patient Manage Page</title>
        ...
        <div class="main-wrapper">
            ...
            <div class="page-wrapper">
                <div class="content container-fluid">
							...
							<div class="col-sm-12">
								...
								<ul class="breadcrumb">
                                    ...
                                    <button
										...
										value="submit">
										<li class="breadcrumb-item" id="show_pat_form"> / Add Patient</li>
									</button>
					...
					<form action="" id="pat_form" class="container">
						...
						<input type="submit" name="submit" id="addpat" class="form-control btn-btn-outline-primary" placeholder="submit">
					</form>
...
<td>".$id."</td>
 ...
 <td>".$row['phone']."</td>
 <td>".$row['email']."</td>
 <td> <button class='btn btn-outline-primary update' data-id='".$id."'><i class='fa-solid fa-pen-to-square'></i></button></td>
 <td><button class='btn btn-outline-primary delete' data-id='".$id."'><i class='fa-solid fa-trash'></i></button></td>
