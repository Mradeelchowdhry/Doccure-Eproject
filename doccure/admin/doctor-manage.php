...
if (isset($_SESSION['isadmin']) && $_SESSION['isadmin'] == true) {
	...
	<head>
		...
		<title>Doccure - Doctor Manage Page</title>
		...
		<div class="main-wrapper">
                ...
                <div class="sidebar-inner slimscroll">
					<div id="sidebar-menu" class="sidebar-menu">
						<ul>
							...
							<li class="active"> 
								<a href="doctor-manage.php"><i class="fe fe-user-plus"></i> <span>Doctors</span></a>
							</li>
							<li> 
								<a href="patient-manage.php"><i class="fe fe-user"></i> <span>Patients</span></a>
							</li>
			...
			<div class="page-wrapper">
				<div class="content container-fluid">
						...
						<div class="row">
							<div class="col-sm-12">
								...
								<ul class="breadcrumb">
									...
									<button
										style="border:none;background-color:rgb(248,249,250);color:rgb(102,101,90);margin-top:-1px;"
										value="submit">
										<li class="breadcrumb-item" id="show_doc_form"> / Add Doctor</li>
									</button>
					...
					<form action="" id="doc_form" class="container">

						<input type="hidden" name="id" id="id">
						<input type="hidden" name="userid" id="userid">
						<input type="text" name="Name" id="Name" class="form-control" placeholder="Enter Your Name">
						<input type="text" name="Email" id="Email" class="form-control" placeholder="Enter Your Email">
						<input type="text" name="Role" id="Role" class="form-control" placeholder="Enter Your Role">
						<select name="city" id="city" class="form-control my-3" >
    <option value="" disabled selected>Choose City</option>
<?php 
$getCategories="SELECT * from cities;";
...
if(mysqli_num_rows($getCategories_run) > 0){
    while($category=mysqli_fetch_assoc($getCategories_run)){
        echo'<option value="'.$category['city_id'].'" >'.$category['city_name'].'</option>';
    }
}
...
?>
						...
						<input type="text" name="Speciality" id="Speciality" class="form-control" placeholder="Enter Your Speciality">
						<input type="text" name="Password" id="Password" class="form-control" placeholder="Enter Your Password">
						<input type="submit" name="submit" id="adddoc" class="form-control btn-btn-outline-primary" placeholder="submit">
					</form>
									...
									<div class="table-responsive ">
										<table class="datatable table table-hover table-center mb-0">
											...
											<tbody>
												...
												$read = "SELECT * FROM `doctors` as doc inner join `cities` as c on doc.city_id=c.city_id;";
