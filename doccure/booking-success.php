...
$get="SELECT  a.doctor_id as d ,a.appointment_date as ad, doc.name  FROM `appointments` as a INNER JOIN doctors as doc on a.doctor_id=doc.doctor_id ORDER by a.appointment_id DESC limit 1;";
    $result2=mysqli_query($connection, $get) or die("failed to run query");
    if($result2){
...
?>
										...
										<p>Appointment booked with <strong>Dr. <?php echo "$dname" ?></strong><br> on <strong><?php echo"$date" ?></strong></p>
