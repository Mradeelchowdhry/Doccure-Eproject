					...
					<ul class="nav header-navbar-rht">
						...
						<li class="nav-item dropdown has-arrow logged-item">
							<a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
								<span class="user-img">
									<img class="rounded-circle" src="images/<?=$pat_image?>" width="31" alt="Darren Elder">
								</span>
							</a>
					...
					<div class="row">
						<div class="col-12">
								...
								<div class="card-body">
									<div class="booking-doc-info">
										...
										<div class="booking-info">
											<h4><a href="#">Our Trusted Doctors</a></h4>
											<div class="rating">
							...
							<div class="card booking-schedule schedule-widget">
								...
								<!-- Schedule Content --><div class="card">
								<form action="" method="post">
									<div class="form-group">
										<input class="form-control" type="text" name="name" placeholder="Enter your name">
									</div>
									<div class="form-group">
										<input class="form-control" type="text" name="phone" placeholder="Enter contact number">
									</div>
									<div class="form-group">
										<input class="form-control" type="email" name="email" placeholder="Enter your email">
									</div>

									<select name="doc_id" id="doc_id" class="form-control my-3" >
    <option value="" disabled selected>Choose doc</option>
<?php 
$getDoctors="SELECT * from doctors;";
$getDoctors_run=mysqli_query($connection, $getDoctors) or die("failed to get categories");
if(mysqli_num_rows($getDoctors_run) > 0){
    while($doctors=mysqli_fetch_assoc($getDoctors_run)){
...
?>
									...
									<div class="form-group">
										<input class="form-control" type="date" name="appoinment_date" placeholder="Enter appointment date">
									</div>
...
if(isset($_POST['checkout'])){
	...
	$status="pending..";  
  $appoinment_date= mysqli_real_escape_string($connection,$_POST['appoinment_date']);
 

 
//   // Get the selected date from a form
//   $selectedDate = $_POST['appointment_date']; // Assuming the form field is named 'appointment_date'
  ...
  if ($appoinment_date < $currentDate) {
    ...
    $add="INSERT INTO `appointments`( `doctor_id`, `patient_id`, `appointment_date`, `appointment_status`) VALUES ('$doc_id',' $pat_id','$appoinment_date','$status');";
    $result2=mysqli_query($connection, $add) or die("failed to run query");
    if($result2){

			echo " <script>alert('Appointment rquest send successfully ')
